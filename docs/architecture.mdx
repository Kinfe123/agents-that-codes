...
These pages cover architecture for Coding Agent Template.

## When to Use This Section
Architecture is the starting point for related workflows in Coding Agent Template. Choose the page that matches the workflow, integration, or reference surface you need, then follow its setup and verification guidance.
