...
## Purpose and Scope
Coding Agent Template is easiest to understand when the major subsystems are visible first. This page explains the real runtime areas in the repository, how they connect, and which reader-facing docs pages to use next.
## Primary Subsystems
...
- The package surface starts from `coding-agent-template` and any additional exported entrypoints.
- Request or route handling is grounded in 11 source files.
